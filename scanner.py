...
image = cv2.imread('G:\\document-scanner-master\\test_s1.jpg')
...
cv2.imwrite("Original Gray.jpg", gray)
cv2.imwrite("Original Blurred.jpg", blurred)
cv2.imwrite("Original Edged.jpg", orig_edged)
cv2.imwrite("Outline.jpg", image)
cv2.imwrite("Thresh Binary.jpg", th1)
cv2.imwrite("Thresh mean.jpg", th2)
cv2.imwrite("Thresh gauss.jpg", th3)
cv2.imwrite("Otsu's.jpg", th4)
